/**
 * Relation definitions for Services filter metadata
 */
...
export function getRelations(): RelationMetadata[] {
  return [
    ...
    },
    {
      name: 'dependencies',
      type: 'many',
      label: formatFieldLabel('dependencies'),
      model: 'ServiceDependency',
      fields: [
        { key: 'dependencyServiceId', label: formatFieldLabel('dependencyServiceId'), type: 'INT' },
        { key: 'dependencyService.name', label: formatFieldLabel('dependencyServiceName'), type: 'STRING' },
      ],
    },
    {
      name: 'groups',
