...
export function useCreateCredential() {
  ...
  return useMutation<Credential, Error, Omit<Credential, 'id' | 'createdAt'>>({
...
export function useUpdateCredential() {
  const queryClient = useQueryClient();
  return useMutation<Credential, Error, { id: number; data: Partial<Omit<Credential, 'id' | 'createdAt'>> }>({
